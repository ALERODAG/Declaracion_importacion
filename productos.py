...
class ProductExtractor:
    ...
    def extract_products_from_text(self, text: str, pdf_filename: str) -> pd.DataFrame:
        ...
        try:
            # 1. INICIO DE EXTRACCIÓN: Se busca or la primera coincidencia de la primera coincidencia de "PRODUCTO"
            ...
            # Despues de obtener la primera coincidencia, extraer texto desde el primer PRODUCTO hasta el final
            products_section = text[first_product_idx:]

            # 2. DEBIDO A LA COMPLEJIDAD DEL MANEJO DE MÚLTIPLES DECLARACIONES, SE PROCEDE CON CADA DECLARACIÓN
            # Dividir el texto en declaraciones individuales
            ...
            # 4. CREAR DATAFRAME, el dataframe tendrá las columnas especificadas, segun la estructura de campos
            # Columnas: archivo_origen, declaracion_numero, PRODUCTO, MARCA, MODELO, REFERENCIA, SERIAL, USO_O_DESTINO, TIPO_DE_MOTOR, PAIS_ORIGEN, CANT
    ...
    def _parse_product_block(self, block: str, decl_num: str, pdf_filename: str) -> Optional[Dict[str, Any]]:
        ...
        # Buscar cada etiqueta y extraer su valor, para cada campo, se usan expresiones regulares para que la extracción sea robusta
